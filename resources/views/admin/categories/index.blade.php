...
@section('container')
  ...
  <div class="table-responsive">
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $category->slug }}</td>
          <td>
            <a href='/admin/categories/{{ $category->slug }}/edit ' class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i></a>
    ...
    <a href='/admin/categories/create' class="btn btn-secondary btn-sm"><i class="bi bi-folder-plus"></i> Create New Category</a>
  </div>
@endsection
