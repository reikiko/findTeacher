  ...
  <body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">Signing up as <a class="text-orange-500">Student</a>.</p>
        </section>

        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="/registerstudent">
                @csrf
                ...
                @enderror
                <div class="mb-3 pt-3 rounded bg-gray-200">
                  <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="address">Address</label>
                  <input placeholder="address" type="text" id="address" name="address" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 transition duration-300 px-3 pb-3">
                </div>
                @error('address')
                <div class="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                    <svg class="inline flex-shrink-0 mr-3 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                ...
                @enderror
                <div class="mb-3 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="school">School</label>
                    <input placeholder="school" type="text" id="school"  name="school" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 transition duration-300 px-3 pb-3">
                </div>
                @error('school')
                <div class="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                    <svg class="inline flex-shrink-0 mr-3 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
    ...
    <div class="max-w-lg mx-auto text-center mt-12 mb-6">
        <p class="text-gray-700">Already have an account? <a href="/loginstudent" class="font-bold hover:underline">Sign in</a>.</p>
    </div>
