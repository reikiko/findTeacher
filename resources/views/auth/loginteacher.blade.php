  ...
  <body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">Sign in to your account<a class="text-orange-500"> as Teacher</a>.</p>
        </section>
        ...
        @endif
        <section class="mt-4">
            <form class="flex flex-col" action="/loginteacher" method="post">
                @csrf
    ...
    <div class="max-w-lg mx-auto text-center mt-12 mb-6">
        <p class="text-gray-700">Don't have an account? <a href="/registerteacher" class="font-bold hover:underline">Sign up</a>.</p>
    </div>
