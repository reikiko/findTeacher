...
<html lang="en">
  ...
  <body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0">
    <header class="max-w-lg mx-auto">
        <a href="/">
            <center><img src="{{ asset('img/findteacher-white.png') }}" class="h-12"></center>
        </a>
    </header>

    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <section>
            <h3 class="font-bold text-2xl">This is FindTeacher</h3>
            <p class="text-gray-600 pt-2">Signing up as <a class="text-orange-500">Admin</a>.</p>
        </section>

        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="/registeradmin">
                @csrf
                ...
                @enderror
                <button class="mt-6 bg-gray-800 hover:bg-black text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign Up</button>
            </form>
        </section>
    </main>

    <div class="max-w-lg mx-auto text-center mt-12 mb-6">
        <p class="text-white">Already an admin? <a href="/loginadmin" class="font-bold hover:underline">Sign in</a>.</p>
    </div>

    <footer class="max-w-lg mx-auto flex justify-center text-white">
        <a href="#" class="hover:underline">You don't need Contact</a>
        <span class="mx-3">•</span>
        <a href="#" class="hover:underline">You control The Privacy</a>
    </footer>
</body>
</html>
